...
<body class="hold-transition login-page "style="background-color:#99e699;">
<div class="login-box">
  <div class="login-logo mb-4">
    <img src="dist/img/mark.png" class="img-thumbnail p-0 border rounded-circle" id="system-logo">
    <div class="text-center h2 mb-0">MED TRACKR</div>
  </div>
  <!-- /.login-logo -->
